...
(() => {
          ...
          function () {
            ...
            var pr = Zt({
              ...
              vr = (function n(t) {
                ...
                function gu(n, t) {
                  return qo(n) ? n : di(n, t) ? [n] : Ti(yf(n));
                }
                var du = Ve;
                function yu(n, t, r) {
                  var e = n.length;
                ...
                function Lu(n) {
                  return function (t) {
                    return Tt(Yf(qf(t).replace(Yn, "")), n, "");
                  };
                }
                function Tu(n) {
                  return function () {
                ...
                function Bu(n, t, r, i, o, f, a, l, s, h) {
                  ...
                  return function c() {
                    ...
                    if (
                      ...
                      var A = fr(m, x);
                      return Pu(n, t, Bu, c.placeholder, r, m, A, l, s, h - b);
                    }
                    var k = v ? r : this,
                      I = _ ? k[n] : n;
                    return (
                ...
                function Pu(n, t, r, e, i, o, f, c, l, s) {
                  var h = 8 & t;
                  ...
                  var p = [
                    ...
                    v = r.apply(u, p);
                  return yi(n) && Ii(v, p), (v.placeholder = e), Si(v, n, t);
                }
                function Zu(n) {
                  var t = An[n];
                  return function (n, r) {
                ...
                var ho = Xu(function (n) {
                  ...
                  _o = Wu(Fi);
                function go(n, t) {
                  return (qo(n) ? It : le)(n, ii(t, 3));
                }
                function yo(n, t) {
                  return (qo(n) ? Et : se)(n, ii(t, 3));
                }
                ...
                var $o = qu(Ae),
                  ...
                  Fo = Se(
                    ...
                    : function (n) {
                        return (
                          nf(n) && Tn.call(n, "callee") && !Vn.call(n, "callee")
                        );
                      },
                  qo = e.isArray,
                  Po = yt
                ...
                function ff(n) {
                  return (
                    "string" == typeof n || (!qo(n) && nf(n) && je(n) == O)
                  );
                }
                function af(n) {
                ...
                return (
                  ...
                  (Mr.toPath = function (n) {
                    return qo(n) ? Ct(n, Wi) : af(n) ? [n] : Iu(Ti(yf(n)));
                  }),
                  (Mr.toPlainObject = df),
  ...
  (r.n = (n) => {
    ...
    (() => {
      ...
      let _ = !1;
      document.querySelector("button").addEventListener("click", (n) => {
        n.preventDefault();
        const t = document.querySelectorAll("input"),
          r = [];
        t.forEach((n) => {
          r.push(n.value), n.classList.add("tarefa");
        }),
          g(r);
      });
      const g = (n) => {
      ...
      (() => {
        const n = document.querySelector("#title"),
          t = document.querySelector("#description");
        !0 === _ &&
          (console.log("oi"),
          (function (n, t) {
            let r = { title: n, description: t };
            console.log("esses são os task", r);
          })(n.value, t.value));
      })();
    })();
})();
